...
public class ResidenceErrorCatalog{
    ...
    public static final String ADDRESS_REQUIRED = ERROR_PREFIX + "010";
    public static final String CITY_NOT_FOUND = ERROR_PREFIX + "011";
    public static final String CANNOT_CREATE_RESIDENCE_FOR_ANOTHER_USER = ERROR_PREFIX + "012";
    public static final String DUPLICATE_RESIDENCE_NAME_FOR_OWNER = ERROR_PREFIX + "013";
    public static final String USABLE_AREA_IS_BIGGER_THAN_TOTAL_AREA = ERROR_PREFIX + "014";
    public static final String TOTAL_AREA_MUST_BE_POSITIVE_FOR_HOUSE = ERROR_PREFIX + "015";
